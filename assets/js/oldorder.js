app.controller('oldorder', function($scope,$http,$rootScope) { 
...
// alert(order);
      ...
      $http({
            method:'GET',
            url:$rootScope.Base_url+"Oldordersboy/getdel",  
...
$scope.showorders = function(data){
    ...
    $http({
            method:'POST',
            url:$rootScope.Base_url+"Oldordersboy/getpickdata",  
  ...
  $scope.delivered = function(data) {
      ...
      $http({
            method:'POST',
            url:$rootScope.Base_url+"Oldordersboy/approve",  
    ...
    $scope.cancel = function(data) {
      ...
      $http({
            method:'POST',
            url:$rootScope.Base_url+"Oldordersboy/cancel",  
            data : $.param({"data":data.ord}),
            }).then(function (response){
                $('#Loader').hide();
                // alert(response.data);
