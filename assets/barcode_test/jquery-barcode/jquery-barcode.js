...
(function ($) {
  ...
  function digitToCssRenderer($container, settings, digit, hri, mw, mh) {
    ...
    if (settings.showHRI) {
      content += "<div style=\"clear:both; width: 100%; font-weight:800 ; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: center; font-size: 13px; margin-top: " + settings.marginHRI + "px;\">" + hri + "</div>";
    }
