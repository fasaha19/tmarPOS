...
define('PAYTM_MERCHANT_KEY', 'drdlcEtLqhDadPJd'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'hlOHCu42300661058845'); //Change this constant's value with MID (Merchant ID) received from Paytm.
